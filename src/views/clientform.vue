    ...
    <div class="px-10 py-20">
      ...
      <form @submit.prevent="submitForm">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-x-6 gap-y-10">
          ...
          <!-- Allows user to input middle name -->
          <div class="flex flex-col">
            <label class="block">
          ...
          <!-- Allows user to input last name -->
          <div class="flex flex-col">
            <label class="block">
          ...
          <!-- Allows user to input phone number -->
          <div class="flex flex-col">
            <label class="block">
          ...
          <!-- Allows user to input alternative phone number -->
          <div class="flex flex-col">
            <label class="block">
        ...
        <div class="mt-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-x-6 gap-y-10">
          ...
          <!-- Allows user to input address line 1 -->
          <div class="flex flex-col">
            <label class="block">
          ...
          <!-- Allows user to input address line 2 -->
          <div class="flex flex-col">
            <label class="block">
          ...
          <!-- Button to submit new client information -->
